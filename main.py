...
if __name__ == "__main__":
    uvicorn.run("main:app", host="0.0.0.0", port=8000, reload=True, ssl_keyfile="/etc/letsencrypt/live/simulatesuccess.info/privkey.pem", ssl_certfile="/etc/letsencrypt/live/simulatesuccess.info/fullchain.pem")